  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        {errorCount ? (
          <span className="inline-flex shrink-0 items-center gap-1 rounded-lg border border-zeta-error/40 bg-zeta-errorSoft px-2 py-1 text-xs font-semibold text-zeta-error">
            <AlertCircle size={13} />
            {errorCount}
          </span>
        ) : null}
      ...
      <div className="flex flex-col gap-2 sm:gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {hasError ? (
              <span className="inline-flex items-center gap-1 rounded-lg border border-zeta-error/40 bg-zeta-errorSoft px-2 py-1 text-xs font-semibold text-zeta-error">
                <AlertCircle size={13} />
                오류
              </span>
            ) : null}
