  ...
  return (
    <div className={cn("relative", className)} ref={containerRef}>
      <button
        ...
        className="inline-flex size-10 shrink-0 items-center justify-center rounded-full border border-zeta-line bg-zeta-panel text-zeta-muted transition hover:bg-zeta-panel2 hover:text-zeta-text focus-visible:ring-2 focus-visible:ring-zeta-accent focus-visible:ring-offset-2"
