...
export const zetaThemes = [
  {
    ...
    variables: {
      ...
      "--zeta-error": "248 113 113",
      "--zeta-error-soft": "69 26 26",
      "--zeta-success": "52 211 153",
      "--zeta-success-soft": "15 58 40",
      "--zeta-info": "96 165 250",
      "--zeta-info-soft": "20 45 75",
  ...
  },
  {
    ...
    variables: {
      ...
      "--zeta-button-text": "255 255 255",
      "--zeta-error": "220 38 38",
      "--zeta-error-soft": "254 226 226",
      "--zeta-success": "22 163 74",
      "--zeta-success-soft": "220 252 231",
      "--zeta-info": "37 99 235",
      "--zeta-info-soft": "219 234 254",
  ...
  },
  {
    ...
    variables: {
      ...
      "--zeta-success": "52 211 153",
      "--zeta-success-soft": "15 58 40",
      "--zeta-info": "45 212 191",
      "--zeta-info-soft": "17 62 58",
      "--zeta-font-family": systemFont,
  ...
  },
  {
    ...
    variables: {
      ...
      "--zeta-error": "190 18 60",
      "--zeta-error-soft": "255 228 230",
      "--zeta-success": "22 163 74",
      "--zeta-success-soft": "220 252 231",
      "--zeta-info": "37 99 235",
      "--zeta-info-soft": "219 234 254",
  ...
  },
  {
    ...
    variables: {
      ...
      "--zeta-error": "180 40 40",
      "--zeta-error-soft": "254 235 235",
      "--zeta-success": "34 138 63",
      "--zeta-success-soft": "225 245 232",
      "--zeta-info": "37 99 235",
      "--zeta-info-soft": "219 234 254",
      "--zeta-font-family": roundedFont,
  ...
  },
  {
    ...
    variables: {
      ...
      "--zeta-button-text": "255 255 255",
      "--zeta-error": "180 10 10",
      "--zeta-error-soft": "254 240 240",
      "--zeta-success": "22 120 60",
      "--zeta-success-soft": "225 250 235",
      "--zeta-info": "37 99 235",
      "--zeta-info-soft": "219 234 254",
  ...
  },
  {
    ...
    variables: {
      ...
      "--zeta-error": "170 30 30",
      "--zeta-error-soft": "254 240 240",
      "--zeta-success": "25 110 45",
      "--zeta-success-soft": "228 248 234",
      "--zeta-info": "37 99 235",
      "--zeta-info-soft": "219 234 254",
